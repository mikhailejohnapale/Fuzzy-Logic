...
input_d = 0.6
input_v = 0.43
v = Fuzzifier(input_v, velocitySet)
d = Fuzzifier(input_d, densitySet)

v.getFuzzy()
d.getFuzzy()

fuzz_v = v.getTestVal()
fuzz_sub = v.getTestSub()

fuzz_d = d.getTestVal()
fuzz_sub_d = d.getTestSub()

print(
    'Velocity fuzzy value:{0}'.format(input_v),
    fuzz_v,
    '\nsubset:',
    fuzz_sub,
    end='\n\n\n')
print(
    'Density fuzzy value:{0}'.format(input_d),
    fuzz_d,
    '\nsubset:',
    fuzz_sub_d,
    end='\n\n')
